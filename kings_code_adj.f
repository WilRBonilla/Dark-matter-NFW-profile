      ...
      parameter (N=600, cv=3.d5, ho=68.d0,ngriddy=50)
...
c      common/pass3/sig
      external dangg
        ...
        open(unit=34,file="telescope.txt",form="formatted")
...
cc zero out arrays
	num = 968
	     ...
	     do iii=1,num
	     	...
	     	read(34,*)xxx,yyy,ep1,ep2

c			write(*,*)xxx,yyy,ep1,ep2
